...
class UnalignedDataset(BaseDataset):
    def initialize(self, opt):
        ...
        self.C_imgs, self.C_paths = store_dataset(self.dir_C)
        ...
        # self.transform1=get_transform1()
    ...
    def __getitem__(self, index):
        ...
        C_img = self.C_imgs[index % self.C_size]
        A_path = self.A_paths[index % self.A_size]
        B_path = self.B_paths[index % self.B_size]
        ...
        if self.opt.resize_or_crop == 'no':
            ...
            input_img = A_img
            r1, g1, b1 = C_img[0] + 1, C_img[1] + 1, C_img[2] + 1
            C_gray = 1. - (0.299 * r1 + 0.587 * g1 + 0.114 * b1) / 2.
            ...
            A_gray = 1. - (0.299 * r + 0.587 * g + 0.114 * b) / 2.
            A_gray = torch.unsqueeze(A_gray, 0)
        return {'A': A_img, 'B': B_img, 'C': C_img, 'D': D_img, 'A_gray': A_gray, 'C_gray': C_gray,
                'input_img1': input_img1, 'input_img': input_img,
